...
export const translations = {
    en: {
        ...
        "creativeDirectionPresets": "Working Style Presets",
        ...
        "workshopLauncherHint": "Open the Studio Workshop window for the full live timeline, memory inspector, and steering controls. The side panel below stays useful as a quick monitor and for generating outputs.",
        "openWorkshop": "Open Studio Workshop",
        "latestActivity": "Latest activity",
        "quickMonitorEmpty": "No turns yet. Start a run to see the latest activity here, or open the Workshop for the full timeline.",
        "liveTimeline": "Live Timeline",
        "interventionDock": "Steering",
        "interventionDockEyebrow": "Steer without breaking flow",
        "forceNarrow": "Push toward narrowing",
        "requestConclusion": "Wrap up now",
        "reviewEscalation": "Open escalation",
        "moderatorOverride": "Moderator note",
        ...
        "continueSession": "Add more rounds",
        "finales": "Generate Output",
        ...
        "memoryPreview": "Saved memory (this session)",
        "memoryPreviewEmpty": "Memory entries will appear after checkpoints or moderator decisions.",
        "promptMemoryPreview": "Memory sent to agents this turn",
    ...
    ar: {
        ...
        "workshopLauncherHint": "افتح نافذة استوديو الورشة للحصول على المخطط الزمني الكامل، ومستعرض الذاكرة، وأدوات التوجيه. تبقى اللوحة الجانبية مفيدة كشاشة مراقبة سريعة وللحصول على المخرجات.",
        "openWorkshop": "افتح استوديو الورشة",
        "latestActivity": "آخر نشاط",
        "quickMonitorEmpty": "لا توجد أدوار بعد. ابدأ جلسة لعرض آخر نشاط هنا، أو افتح الورشة لرؤية المخطط الزمني الكامل.",
